...
local cb=bb:MakeWindow({Name="YungHub | SL2 Edition",HidePremium=false,SaveConfig=true,ConfigFolder="OrionTest",IntroEnabled=true,IntroText="Welcome To YungHub FREE | SL2",IntroIcon="rbxassetid://8387311864"})
bb:MakeNotification({Name="We Appreciate It! - Aqua & SheppozZ",Content="Hi! we just wanted to thank you for choosing YungHub, Have fun hacking, the easy way.",Image="rbxassetid://11982227421",Time=10})
...
game:GetService("Players").BL00DLESE.Valuestats.Karma:Destroy()print("Karma Removed.")end})
...
game:GetService("ReplicatedStorage").DoorService:FireServer("HOP",dd:FindFirstChild(
cd.Name.."'s Car"))print("button pressed")end})
cc:AddButton({Name="School",Callback=function()local cd=game.Players.LocalPlayer
...
local bd=cb:MakeTab({Name="Credits",Icon="rbxassetid://10885640682",PremiumOnly=false})bd:AddLabel("Thanks For Using YungHub!")
bd:AddLabel("Main Scripter | Aqua #0999")bd:AddLabel("Head Developer | SheppozZ#6252")
bd:AddLabel("Senior Developer | xurel#7777")bd:AddLabel("Developers | NAS#2617 & kenji#4881")
